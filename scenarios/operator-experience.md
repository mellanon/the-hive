...
│  Status: 🟢 Open                                               │
│                                                                 │
│  FEEDBACK (across all hives)                                    │
│  ✅ 61 positive    ⬜ 5 neutral    ❌ 1 negative               │
│  ██████████████████████████████████████░░░░                      │
│  91% positive (67 ratings)                                      │
│                                                                 │
│  BADGES                                                         │
│  ⭐ Hive Star (3 quarters) · 🛡️ Guardian (1 quarter)           │
│                                                                 │
│  DIMENSION RATINGS (all hives, 67 reviews)                      │
...
│  HIVE MEMBERSHIPS                                               │
│  ┌──────────────────┬────────────┬──────────────────┬──────────┐│
│  │ Hive             │ Role       │ Feedback         │ Work     ││
│  ├──────────────────┼────────────┼──────────────────┼──────────┤│
│  │ security-tools   │ Maintainer │ 95% pos (37)     │ 23 items ││
│  │ community-tools  │ Reviewer   │ 88% pos (24)     │ 12 items ││
│  │ acme-internal    │ Contributor│ 83% pos (6)      │ 5 items  ││
│  └──────────────────┴────────────┴──────────────────┴──────────┘│
│                                                                 │
│  RECENT ACTIVITY                                                │
